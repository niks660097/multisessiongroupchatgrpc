...
type UserRequest struct {
	...
	Username             string          `protobuf:"bytes,2,opt,name=username,proto3" json:"username,omitempty"`
	SessionUsernames     []string        `protobuf:"bytes,3,rep,name=session_usernames,json=sessionUsernames,proto3" json:"session_usernames,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *UserRequest) GetSessionUsernames() []string {
	if m != nil {
		return m.SessionUsernames
	}
	return nil
}
...
var fileDescriptor_32cc09492b18c0da = []byte{
	...
	,
}
